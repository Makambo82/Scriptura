...
NICHE (clarté du positionnement) : à partir des sujets visibles dans le top contenus (et de la niche déclarée par le créateur si elle est fournie), juge si le compte a un positionnement CLAIR (une ligne éditoriale cohérente et reconnaissable) ou FLOU (plusieurs sujets/identités sans lien évident, qui diluent l'algorithme et l'audience). Base-toi UNIQUEMENT sur les sujets réellement visibles dans les captures ; si le top contenus est absent ou trop court pour juger, indique "disponible": false plutôt que de deviner. Si tu identifies une sous-niche plus précise et moins concurrentielle que la niche déclarée, mentionne-la comme piste, sans l'affirmer comme une certitude.

ANALYSE DÉTAILLÉE (à partir UNIQUEMENT du top contenus, n'utilise aucune autre capture pour cette section) :
- videos_au_dessus_moyenne : parmi les vidéos visibles dans le top contenus, compte combien se détachent nettement au-dessus de la moyenne du compte (pas une différence de quelques pourcents, un écart net). Indique aussi total_videos_analysees (le nombre total de vidéos visibles dans le top contenus, généralement jusqu'à 10).
- concepts_recurrents : à partir des légendes/titres visibles sur ces mêmes vidéos, regroupe-les par thème et compte combien de vidéos partagent chaque thème récurrent (uniquement les thèmes qui reviennent sur AU MOINS 2 vidéos, ignore les thèmes qui n'apparaissent qu'une fois, ce ne sont pas des concepts récurrents). N'invente aucun thème si les légendes ne sont pas lisibles ou pas assez explicites.
Ne tente JAMAIS d'identifier des vidéos "flop" ici : le top contenus ne montre par nature que les meilleures vidéos de la période, jamais les moins bonnes, ne prétends pas voir des sous-performances que cette capture ne peut pas montrer. Si le top contenus est absent, trop court, ou que les légendes ne sont pas lisibles, "disponible": false plutôt que d'inventer.
...

{
  ...
  "piliers": {
    ...
    "niche":              { "disponible": <true/false>, "nom": "<la niche/ligne éditoriale telle qu'observée>", "etat": "<claire|floue>", "analyse": ["<1 à 3 points concrets : chevauchement de sujets, sous-niche plus précise et moins concurrentielle si identifiable, etc.>"] },
  ...
  "synthese_croisee": { "disponible": <true UNIQUEMENT si un diagnostic sommaire a été fourni plus haut ; false sinon, et dans ce cas laisse constat et points vides>, "constat": "<2 à 4 phrases qui CROISENT le contenu (sommaire : niche réelle, formule gagnante, éventuel changement de cap, top/flop sur ~6 mois de vraies vidéos) et la diffusion, comment l'algo le pousse (captures : rétention, sources de trafic, démographie). Dis surtout ce que le CROISEMENT révèle que ni l'une ni l'autre ne montrait seule. Évite le mot « distribution », préfère « diffusion » ou « comment l'algo te pousse ».>", "points": ["<1 à 3 points de convergence ou de tension entre contenu et diffusion, concrets et chiffrés quand possible>"] },
  "axes_prioritaires": [
